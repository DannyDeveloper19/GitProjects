...
namespace Market_Manager.Models
{
    public struct EmployerModel
    {
        ...
        public EmployerModel(string id, string name, string lastname, string address, string phone, string email, string dln, string role,string id_logged = "", byte[] picture = null)
        {
            id_employer = id;
            employer_name = name;
            employer_role = role;
